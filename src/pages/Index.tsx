...
const Index = () => {
  ...
  const renderTab = () => {
    switch (activeTab) {
      ...
      case 'journal': return <div className="p-4"><h1 className="text-3xl font-serif font-bold">Journal</h1><p className="text-muted-foreground mt-2">Bientôt disponible</p></div>;
      case 'habits': return <div className="p-4"><h1 className="text-3xl font-serif font-bold">Habitudes</h1><p className="text-muted-foreground mt-2">Bientôt disponible</p></div>;
